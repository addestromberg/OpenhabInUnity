...
namespace se.Studio13.OpenHabUnity
{
    ...
    /// Switch Widget
    /// ------------
    /// This widget is as it sounds Equal to Switch in HabPanel.
    /// A Toggle switch. Usually for switching on/off lights.
    /// 
    ...
    /// </summary>
    public class OpenhabSwitchWidget : MonoBehaviour
    {
